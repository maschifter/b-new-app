...
// load under Node). Auto-applied to every test because it lives in the package
// root __mocks__ for a node_modules package. Stores are keyed by MMKV `id` so
// instances with different ids stay isolated, matching the real module.
//
